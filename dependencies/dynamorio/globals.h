...
#ifndef DYNAMORIO_GLOBALS_H_
#define DYNAMORIO_GLOBALS_H_

#define GRANARY
#define NOT_DYNAMORIO_CORE_PROPER

#define HEAP_ACCOUNTING
#define heap_free dynamorio_heap_free
#define heap_alloc dynamorio_heap_alloc
#define FAULT granary_break_on_fault()
...
#include "dependencies/dynamorio/x86/proc.h"
#include "dependencies/dynamorio/link.h"
#include "dependencies/dynamorio/core/heap.h"
...
extern void *dynamorio_heap_alloc(void *, unsigned long long, int);
extern void dynamorio_heap_free(void *, void *, unsigned long long, int);
